    ...
    <motion.div whileHover="hover">
      <motion.div className={footerContainerStyles}>
        <motion.div layout variants={primaryFooterVariants}>
          <p className="text-sm xl:text-base font-light">&copy; 2022 Vidit Khandelwal</p>
        </motion.div>
        <motion.div
          layout
        ...
        <motion.div
          layout
          className="text-sm xl:text-base font-light hidden flex-row space-x-1 text-black"
